package com.darien.fnmods.whatsapp.Views;
...
public class InsLoadingView extends ImageView {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
      //  TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.InsLoadingViewAttr);
        int startColor = mStartColor; //typedArray.getColor(R.styleable.InsLoadingViewAttr_start_color, mStartColor);
        int endColor =  mEndColor; //typedArray.getColor(R.styleable.InsLoadingViewAttr_end_color, mEndColor);
        int circleDuration =  mCircleDuration; //typedArray.getInt(R.styleable.InsLoadingViewAttr_circle_duration, mCircleDuration);
        int rotateDuration = mRotateDuration; //typedArray.getInt(R.styleable.InsLoadingViewAttr_rotate_duration, mRotateDuration);
        int status = 0; //typedArray.getInt(R.styleable.InsLoadingViewAttr_status, 0);
        if (DEBUG) {
